  ...
  return (
    <section>
      ...
      <p className="white-text p-tag">
        I am a full-stack developer with 4 years of working experience in
        fields such as scientific research, blockchain, systems engineering, finance, and project management. My background in
        ...
        situations, while my desire to learn pushes me to quickly adapt in an ever-changing web space.
      </p>
    </section>
  );
};
